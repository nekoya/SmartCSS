...
class SCSS_Parser
{
    ...
    private static $yyaction = array(
           24,   12,   25,    0,   26,   27,   28,   29,   30,   31,
           20,   21,   68,   87,   32,   22,   40,    9,   18,   35,
          -25,   33,   15,   95,   96,-32766,   61,   15,   34,   13,
            8,   56,   53,   17,   98,   99,  100,   62,    0,    0,
            0,   97,    0,    0,    0,    0,   14,    0,   16,   19
    );
    ...
    private static $yybase = array(
           ...
           19,   19,   19,   19,   19,   19,   19,    1,    3,   -1,
           17,   14,    8,   10,   18,    7,    9,   -5,    0,    0,
            0,   -9,   -9,   -9,    0,   -9,   -9,   19,    0,    0,
            0,    0,   19
    );
    ...
    private static $yydefault = array(
           ...
           42,   42,   42,   42,   42,   42,   43,32767,32767,32767,
           46,32767,32767,32767,32767,32767,32767,32767,    5
    );

    private static $yygoto = array(
           37,   77,   67,    6,   41,   44,   63,   45,    2,   66,
           46,   89,   88,   86,   90,   85,   78,   80,   81,   79,
           82,   83,   84,   75,   59,   58,   73,   70,   64,   23,
           23,   65,   69,   94
    );
    ...
    private static $yygcheck = array(
            ...
            8,    8,    8,    8,    8,    8,    8,    8,    8,    8,
            8,    8,    8,    8,    8,    8,    8,   11,   11,   14,
           14,   11,   15,   20
    );

    private static $yygbase = array(
            0,    0,    0,    0,    0,    0,    0,    0,   -9,    0,
            0,   21,    0,    0,   27,   26,    0,    0,   -2,    0,
           -3
    );

    private static $yygdefault = array(
        -32768,   38,   50,   48,    7,   10,   55,    3,   42,    1,
           43,   72,   39,    4,   11,   71,    5,   47,   76,   36,
           93
    );
