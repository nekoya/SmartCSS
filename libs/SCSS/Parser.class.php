...
class SCSS_Parser
{
    ...
    private static $yyaction = array(
           30,   87,   31,    0,   32,   33,   34,   35,   36,   37,
           25,   26,   23,   27,  -30,   28,   18,   17,   14,  109,
          110,   18,   50,   81,   41,-32766,   71,   70,   48,   38,
           10,   13,    7,   65,   62,   39,   46,  -30,   40,  111,
           16,  113,    0,   19,   22,    0,    0,    0,   19,  114,
          112,    0,    0,    0,    0,   15,    0,   21
    );
    ...
    private static $yybase = array(
           17,   -8,    4,    4,   14,    9,   11,   23,   15,    2,
           15,   15,   15,   18,   15,   15,   15,   15,   15,   15,
           15,   15,   15,   15,   15,   15,   15,   15,   15,   15,
           15,   15,   15,   15,   15,   15,   15,   15,   15,   15,
           15,   15,   15,    1,   -2,   13,   22,    3,    8,   16,
            7,   10,   12,   24,   19,   21,   20,    0,    0,    0,
            2,    2,    2,    2,    0,   15,    0,    0,    0,    0,
            0,   15
    );
    ...
    private static $yydefault = array(
           ...
           47,   47,   47,   47,   47,   47,   47,   47,   47,   47,
           47,   47,   47,   47,   47,   47,   47,   47,   47,   47,
           47,   47,   48,32767,32767,   16,32767,32767,32767,32767,
           51,32767,32767,32767,32767,32767,32767,    5
    );

    private static $yygoto = array(
           45,   91,   43,   49,   80,   51,    4,   53,   55,   79,
           72,   73,   77,   56,    2,   76,   78,  103,  102,  101,
          100,  104,   99,   92,   94,   95,   93,   96,   97,   98,
           89,   67,   68,   86,   85,   29,   29,   84,   75,   24,
            0,  108
    );
    ...
    private static $yygdefault = array(
        -32768,   47,   59,   57,    8,    9,   52,   64,    3,    1,
           54,   83,   11,    5,   20,   12,   82,    6,   44,   90,
           42,  107
    );

    private static $yylhs = array(
            0,    1,    2,    3,    3,    4,    4,    7,    8,    8,
            8,    9,    9,    9,   10,   10,    5,    5,   11,   11,
    ...
    private function yyn6() {
         $this->yyval = $this->catNode($this->yyastk[$this->yysp-(3-1)], $this->yyastk[$this->yysp-(3-3)]); 
    }
