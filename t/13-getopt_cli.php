...
$t->ok( $c->getTargetFile('../hoge.scss'), 'get scss' );

$t->comment( 'fail getTargetFile' );
$t->is( $c->getTargetFile(''), false, 'empty args' );
$t->is( $c->getTargetFile('none.scss'), false, 'scss file not found' );
$t->is( $c->getTargetFile('hoge.css'), false, 'target file extension must be .scss' );
