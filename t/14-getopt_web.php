...
$t->ok( $c->getTargetFile('../sample/sample.css'), 'get scss, parameter extension is .css' );
...
$t->is( $c->getTargetFile('../sample/sample.scss'), false, 'target file extension must be .css' );
