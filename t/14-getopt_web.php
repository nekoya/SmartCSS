...
$t->ok( $c->getTargetFile('../hoge.css'), 'get scss, parameter extension is .css' );

$t->comment( 'fail getTargetFile' );
$t->is( $c->getTargetFile(''), false, 'empty args' );
$t->is( $c->getTargetFile('none.css'), false, 'css file not found' );
$t->is( $c->getTargetFile('hoge.scss'), false, 'target file extension must be .css' );
